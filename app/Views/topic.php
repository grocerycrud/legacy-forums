    ...
    <div id='branding'>
        <div class='main_width'>
            <div id='logo'>
                ...
                <a href='https://forums.grocerycrud.com' title='Go to community index' rel="home" accesskey='1'><img src='http://www.grocerycrud.com/forums/public/style_images/18_grocery-crud-logo.png' alt='Logo' /></a>
            ...
            <div style="float:right;width:300px;margin-top:-21px;margin-right:-8px;margin-left:10px;">
                ...
                <div id="adblock-detected" style="background: white;margin-top: 5px; border-radius: 10px 10px 0px 0px; padding-bottom: 10px;display: none">
                    <div style="float:left; padding-top: 5px; padding-left: 5px; background: #f9f9f9; border-radius: 10px 0px 0px 0px">
                        <a target="_blank" href="/bootstrap-theme/">
                                <span class="bsa_it_i">
                                    <img height="100" width="130" alt="" src="https://www.grocerycrud.com/v1.x/assets/uploads/general/bootstrap-theme-ad.png">
                                </span>
                        </a>
                    </div>
                    <div style="float:left; margin-left: 10px;width: 140px; font-size: 12px; font-weight: bold; padding-top: 10px">
                        <p>
                            <a target="_blank" href="https://www.grocerycrud.com/bootstrap-theme/" style="text-decoration: none">
                                <span class="bsa_it_d">
                                    Bootstrap Theme<br/><br/>Simply the best theme for Grocery CRUD!
                                </span>
                            </a>
                        </p><br/><br/><p style='text-align:right'>
        ...
        <div id='primary_nav' class='clearfix'>
            <div class='main_width'>
                <ul class='ipsList_inline' id='community_app_menu'>
                    ...
                    <li class='right'>
                        <a href="/index.php?app=core&amp;module=global&amp;section=navigation&amp;inapp=forums" rel="quickNavigation" accesskey='9' id='quickNavLaunch' title='Open Quick Navigation'><span>&nbsp;</span></a>
                    </li>

                    <li id='nav_explore' class='right'>
                        <a href='/index.php?app=core&amp;module=search&amp;do=viewNewContent&amp;search_app=forums' accesskey='2'>View New Content</a>
                    </li>
                    ...
                    <li id='nav_app_members' class="left "><a href='/members/' title='Go to Members'>Members</a></li>



                    <li id='nav_other_apps' style='display: none'>
                        <a href='#' class='ipbmenu' id='more_apps'>More <img src='/public/style_images/master/useropts_arrow.png' /></a>
                    </li>
                </ul>
            </div>
            <script type='text/javascript'>
        ...
        <div id='content' class='clearfix'>
            ...
            <div id='secondary_navigation' class='clearfix'>
                <ol class='breadcrumb top ipsList_inline left'>
                    ...
                    <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                        <span class='nav_sep'>&rarr;</span>
                        <a href='/forum/3-support/' title='Return to Support' itemprop="url"><span itemprop="title">Support</span></a>
                    </li>
                    ...
                    <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                        <span class='nav_sep'>&rarr;</span>
                        <a href='/forum/11-grocery-crud-enterprise/' title='Return to Grocery CRUD Enterprise' itemprop="url"><span itemprop="title">Grocery CRUD Enterprise</span></a>
                    </li>
